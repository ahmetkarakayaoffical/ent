...
func (dq *DeploymentQuery) QueryOwner() *AgentQuery {
	query := (&AgentClient{config: dq.config}).Query()
...
func (dq *DeploymentQuery) WithOwner(opts ...func(*AgentQuery)) *DeploymentQuery {
	query := (&AgentClient{config: dq.config}).Query()
...
func (dq *DeploymentQuery) loadOwner(ctx context.Context, query *AgentQuery, nodes []*Deployment, init func(*Deployment), assign func(*Deployment, *Agent)) error {
