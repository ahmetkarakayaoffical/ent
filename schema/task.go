...
func (Task) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Float("local_user_expires").Optional(),
		...
		field.Int("local_user_password_expire_account_disable").Optional(),
		field.Int("local_user_password_expire_max").Optional(),
		field.Int("local_user_password_expire_min").Optional(),
		field.Int("local_user_password_expire_warn").Optional(),
		...
		field.Int("local_user_id").Optional(),
		field.Int("local_user_id_max").Optional(),
		field.Int("local_user_id_min").Optional(),
