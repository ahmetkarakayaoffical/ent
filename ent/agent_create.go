...
import (
	...
	"github.com/doncicuto/openuem-ent/ent/app"
	"github.com/doncicuto/openuem-ent/ent/computer"
	"github.com/doncicuto/openuem-ent/ent/logicaldisk"
	"github.com/doncicuto/openuem-ent/ent/monitor"
	"github.com/doncicuto/openuem-ent/ent/networkadapter"
	"github.com/doncicuto/openuem-ent/ent/operatingsystem"
	"github.com/doncicuto/openuem-ent/ent/printer"
	"github.com/doncicuto/openuem-ent/ent/share"
	"github.com/doncicuto/openuem-ent/ent/systemupdate"
)
...
func (ac *AgentCreate) check() error {
	...
	if _, ok := ac.mutation.FirstContact(); !ok {
		return &ValidationError{Name: "first_contact", err: errors.New(`ent: missing required field "Agent.first_contact"`)}
	}
	if _, ok := ac.mutation.LastContact(); !ok {
		return &ValidationError{Name: "last_contact", err: errors.New(`ent: missing required field "Agent.last_contact"`)}
	}
	if _, ok := ac.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent: missing required field "Agent.enabled"`)}
	}
