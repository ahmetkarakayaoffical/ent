...
var (
	...
	TasksColumns = []*schema.Column{
		...
		{Name: "local_user_expires", Type: field.TypeFloat64, Nullable: true},
		...
		{Name: "local_user_password_expire_account_disable", Type: field.TypeInt, Nullable: true},
		{Name: "local_user_password_expire_max", Type: field.TypeInt, Nullable: true},
		{Name: "local_user_password_expire_min", Type: field.TypeInt, Nullable: true},
		{Name: "local_user_password_expire_warn", Type: field.TypeInt, Nullable: true},
		...
		{Name: "local_user_id_max", Type: field.TypeInt, Nullable: true},
		{Name: "local_user_id_min", Type: field.TypeInt, Nullable: true},
